...
%% 
% LabelDefinitions 복사
newLabelDefs = data3.gTruth.LabelDefinitions;
...
newLabelData = data3.gTruth.LabelData;
...
allImagePaths = [GT_0_27.DataSource.Source; updatedGTruth.DataSource.Source];
% 새 DataSource 객체 생성
newDataSource = groundTruthDataSource(allImagePaths);


% LabelDefinitions 합치기
combinedLabelDefs = [GT_0_27.LabelDefinitions; updatedGTruth.LabelDefinitions];
...
totalImages = size(GT_0_27.LabelData, 1) + size(updatedGTruth.LabelData, 1);
...
for i = 1:size(GT_0_27.LabelData, 2)
    labelName = GT_0_27.LabelData.Properties.VariableNames{i};
    newLabelData{1: size(GT_0_27.LabelData, 1) , labelName} = GT_0_27.LabelData{:, i};
end
...
for i = 1:size(updatedGTruth.LabelData, 2)
    ...
    newLabelData{size(GT_0_27.LabelData, 1) + 1 : end, labelName} = updatedGTruth.LabelData{:, i};
end


% 새로운 groundTruth 객체 생성
GT_0_36 = groundTruth(newDataSource, combinedLabelDefs, newLabelData);
